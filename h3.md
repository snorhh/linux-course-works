...
Kokeillessani palvelimen pysäyttämistä ja uudelleenkäynnistämistä huomasin, että minun ei aina tarvinnut laittaa sudo-määritettä, vaikka tein toiminnon, joka vaatii sudo-oikeuet. Järjestelmä siis muistaa salasanan jonkin aikaa, ettei sitä tarvitse laittaa jokaisen sudo-komennon jälkeen. Jos taas haluan varmistaa, että järjestelmä on jo "unohtanut" sudo-oikeuteni, voin tehdä sen komennolla *sudo -k*. (Lähde: https://man7.org/linux/man-pages/man8/sudo.8.html)
