...
Ohjeissa neuvotaan asentamaan Apache2, mutta koska olin jo aiemmin asentanu sen, niin tutkin minkälaiset asetukset siinä nyt olivat. 
Kun menin selaimella localhost-osoitteeseen, niin siellä luki"default", jonka olin siis itse kirjoittanut sinne. Muistin virkistykeksi etsin, että teksti tulee kansiosta /var/www/html olevasta index.html-tiedostosta. Varmistin asian muokkaamalla tekstiä hieman.

![Add file: Upload](h6b_02.png)

### Web-sisältöä

Menin omaan kotihakemistooni ja suoritin seuraavat komennot: `mkdir -p publicwsgi/testco/static/` ja "Teksti static-kansiosta."|tee publicwsgi/testco/static/index.html
